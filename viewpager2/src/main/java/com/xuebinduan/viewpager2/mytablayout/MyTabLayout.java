package com.xuebinduan.viewpager2.mytablayout;
 ...
 *
 * <p>You can also add items to MyTabLayout in your layout through the use of {@link TabItem}. An
...
public class MyTabLayout extends HorizontalScrollView {
     ...
     * MyTabLayout's content width. Fixed tabs have equal width, based on the widest tab label. Once the
    ...
    /**
     * Gravity used to lay out the tabs aligned to the start of the {@link MyTabLayout}.
     *
     * @see #setTabGravity(int)
     * @see #getTabGravity()
     */
    ...
    /**
     * Returns the ripple color for this MyTabLayout.
     *
    ...
    /**
     * Sets the ripple color for this MyTabLayout.
     *
    ...
    /**
     * Sets the ripple color resource for this MyTabLayout.
     *
     * <p>When running on devices with KitKat or below, we draw this color as a filled overlay rather
     * than a ripple.
     *
    ...
    /**
     * Returns the selection indicator drawable for this MyTabLayout.
     *
    ...
    /**
     * Sets the selection indicator for this MyTabLayout. By default, this is a line along the bottom of
     * the tab. If {@code tabIndicatorColor} is specified via the MyTabLayout's style or via {@link
    ...
    /**
     * Sets the drawable resource to use as the selection indicator for this MyTabLayout. By default,
     * this is a line along the bottom of the tab. If {@code tabIndicatorColor} is specified via the
     * MyTabLayout's style or via {@link #setSelectedTabIndicatorColor(int)} the selection indicator
     ...
     * The one-stop shop for setting up this {@link MyTabLayout} with a {@link ViewPager}.
     *
     * <p>This method will link the given ViewPager and this MyTabLayout together so that changes in one
     ...
     *     together. When that method is used, the MyTabLayout will be automatically updated when the
    ...
    /**
     * Called when a selected tab is added. Unselects all other tabs in the MyTabLayout.
     *
    ...
    /** A {@link LinearLayout} containing {@link Tab} instances for use with {@link MyTabLayout}. */
    public final class TabView extends LinearLayout {
         ...
         * tab background underneath the MyTabLayout selection indicator, and then draw the MyTabLayout
